...
/* ── Industrial & Scientific: 60 lab / household / industrial chemicals ──
   Each chemical maps to a distinct-enough container photo. There are 17
   different container images (powder-jar, jug, jug2, clear-bottle, crystal-bag,
   amber-bottle, vial-box, spray-bottle, drum, jerrican, dropper, foil-pouch,
   pail, kraft-sack, glass-jar, canister, metal-vial), so visually-identical
   duplicates are minimised across the department. */
...
const CHEM: [string, string, number, number, number][] = [
  ...
  ['Sodium Bicarbonate (Pure Baking Soda), 5 lb', 'glass-jar', 12.49, 4.9, 9870],
  ['Citric Acid (Anhydrous, Food Grade), 2 lb', 'foil-pouch', 13.99, 4.8, 15230],
  ['Isopropyl Alcohol 99% (Technical Grade), 1 Gallon', 'jug', 24.99, 4.8, 22100],
  ['Acetone (ACS Reagent Grade), 1 Gallon', 'jug2', 29.99, 4.7, 6410],
  ['Hydrogen Peroxide 3% (Stabilized), 500 mL', 'clear-bottle', 8.49, 4.7, 5340],
  ['Distilled Water (Lab Purified), 1 Gallon', 'jerrican', 6.99, 4.9, 31200],
  ...
  ['White Distilled Vinegar (Acetic Acid 5%), 1 Gal', 'jug2', 7.49, 4.8, 12040],
  ['Epsom Salt (Magnesium Sulfate USP), 5 lb', 'crystal-bag', 11.99, 4.9, 27600],
  ['Borax (Sodium Tetraborate), 4 lb', 'kraft-sack', 13.49, 4.8, 16720],
  ['Copper(II) Sulfate Pentahydrate, 2 lb', 'crystal-bag', 21.99, 4.7, 3980],
  ['Potassium Nitrate (Saltpeter, 99%), 2 lb', 'foil-pouch', 18.99, 4.6, 5210],
  ['Calcium Chloride (Anhydrous Pellets), 5 lb', 'pail', 16.99, 4.7, 6870],
  ...
  ['Muriatic Acid (Hydrochloric Acid 31.45%), 1 Gal', 'jerrican', 19.99, 4.6, 4530],
  ['Activated Charcoal Powder (Ultra Fine), 1 lb', 'canister', 17.99, 4.8, 20130],
  ['Ascorbic Acid (Vitamin C, Pharma Grade), 2 lb', 'glass-jar', 22.99, 4.9, 13420],
  ...
  ['Titanium Dioxide (Cosmetic Grade), 1 lb', 'metal-vial', 16.49, 4.6, 3320],
  ['Sodium Thiosulfate Pentahydrate, 2 lb', 'crystal-bag', 18.49, 4.6, 2740],
  ['Silver Nitrate (ACS Reagent, 25 g)', 'dropper', 39.99, 4.7, 1180],
  ['Iron(III) Oxide (Red Rouge Powder), 1 lb', 'vial-box', 12.99, 4.6, 4410],
  ['Methylene Blue Solution (1%, Lab Stain), 100 mL', 'dropper', 14.99, 4.7, 2560],
  ['Calcium Carbonate (Precipitated, 99%), 5 lb', 'kraft-sack', 14.49, 4.8, 7130],
  ...
  ['Magnesium Sulfate Heptahydrate (Reagent), 2.5 kg', 'foil-pouch', 17.49, 4.7, 3410],
  ['Potassium Permanganate (Free-Flowing), 1 lb', 'amber-bottle', 19.49, 4.6, 5120],
  ['Sodium Percarbonate (Oxygen Bleach), 5 lb', 'pail', 16.49, 4.8, 8940],
  ['Boric Acid Powder (Technical Grade), 2 lb', 'powder-jar', 11.49, 4.7, 12310],
  ['Xanthan Gum (Food Grade Thickener), 1 lb', 'canister', 13.99, 4.8, 9820],
  ['Sodium Metabisulfite (Preservative), 2 lb', 'foil-pouch', 12.99, 4.6, 3760],
  ['Aluminum Sulfate (Water Treatment), 5 lb', 'kraft-sack', 15.99, 4.6, 2980],
  ['Glacial Acetic Acid (99.7% ACS), 500 mL', 'clear-bottle', 21.99, 4.5, 1640],
  ['Sulfuric Acid Solution (Battery Grade), 1 Gal', 'jerrican', 26.99, 4.5, 2210],
  ['Ammonium Chloride (Fine Powder, 99.5%), 2 lb', 'glass-jar', 13.49, 4.7, 4530],
  ['Sodium Acetate Trihydrate (Reagent), 2 lb', 'glass-jar', 16.99, 4.7, 3120],
  ['Calcium Hypochlorite (Pool Shock 68%), 5 lb', 'pail', 24.99, 4.6, 7640],
  ['Ferric Chloride Solution (PCB Etchant), 1 L', 'amber-bottle', 18.99, 4.6, 5410],
  ['Potassium Hydroxide (Flakes, 90%), 2 lb', 'canister', 17.99, 4.7, 4180],
  ['Sodium Silicate Solution (Water Glass), 1 Gal', 'jug2', 22.49, 4.5, 1890],
  ['Magnesium Chloride Hexahydrate, 5 lb', 'crystal-bag', 14.99, 4.7, 6210],
  ['Tannic Acid (Reagent Powder), 1 lb', 'vial-box', 19.99, 4.6, 2140],
  ['Sodium Carbonate (Soda Ash, Dense), 5 lb', 'kraft-sack', 12.99, 4.8, 9310],
  ['Oxalic Acid (Wood Bleach, 99.6%), 2 lb', 'foil-pouch', 14.49, 4.7, 8720],
  ['Potassium Iodide (ACS Reagent), 100 g', 'metal-vial', 29.99, 4.7, 1560],
  ['Sodium Persulfate (Etchant Grade), 1 lb', 'foil-pouch', 16.99, 4.6, 2310],
  ['Ethylene Glycol (Industrial, 99.9%), 1 Gal', 'jerrican', 21.99, 4.6, 3980],
  ['Lithium Chloride (Anhydrous, 99%), 250 g', 'dropper', 34.99, 4.6, 940],
  ['Sodium Nitrate (Chile Saltpeter, 99%), 2 lb', 'foil-pouch', 15.49, 4.6, 3410],
  ['Copper Powder (Ultra Fine, 99.5%), 1 lb', 'metal-vial', 22.99, 4.7, 2870],
  ['Graphite Powder (Micronized Lubricant), 1 lb', 'canister', 13.99, 4.7, 6540],
  ['Sodium Lauryl Sulfate (Surfactant), 2 lb', 'powder-jar', 16.49, 4.6, 5210],
  ['Calcium Oxide (Quicklime, Reagent), 2 lb', 'pail', 12.99, 4.6, 3120],
  ['Hydrated Lime (Calcium Hydroxide), 5 lb', 'kraft-sack', 11.99, 4.7, 4980],
  ['Zinc Sulfate Monohydrate (Feed Grade), 5 lb', 'pail', 14.99, 4.7, 3610],
];
const CHEM_BADGES: Record<number, Badge> = {
  ...
  33: { kind: 'best', text: '#1 Best Seller' },
  47: { kind: 'choice', text: "Amazon's Choice" },
  58: { kind: 'overall', text: 'Overall Pick' },
};
...
const PRODUCTS: Product[] = [
  ...
  {
    id: 'smart-tv', dept: 'electronics',
    title: '65" 4K QLED Smart TV, Dolby Vision HDR, 120Hz, with Voice Remote',
    price: 699, listPrice: 999, rating: 4.7, reviews: 34210, bought: '4K+ bought in past month',
    badge: { kind: 'best', text: '#1 Best Seller' }, coupon: 10, prime: true, delivery: 'Tomorrow, Jul 20',
  },
  {
    id: 'robovac', dept: 'electronics',
    title: 'Robot Vacuum & Mop Combo, LiDAR Navigation, Self-Emptying Base',
    price: 429, listPrice: 599, rating: 4.6, reviews: 21870, bought: '2K+ bought in past month',
    badge: { kind: 'deal', text: 'Limited time deal' }, coupon: 15, prime: true, delivery: 'Tomorrow, Jul 20',
  },
  {
    id: 'soundbar', dept: 'electronics',
    title: '3.1.2 Dolby Atmos Soundbar with Wireless Subwoofer',
    price: 279, listPrice: 379, rating: 4.6, reviews: 15420, badge: { kind: 'choice', text: "Amazon's Choice" }, prime: true, delivery: 'Tomorrow, Jul 20',
  },
  {
    id: 'camera', dept: 'electronics',
    title: 'Mirrorless Camera 24MP with 18-55mm Lens, 4K60 Video, In-Body Stabilization',
    price: 899, listPrice: 1099, rating: 4.7, reviews: 8940, bought: '1K+ bought in past month',
    badge: { kind: 'overall', text: 'Overall Pick' }, prime: true, delivery: 'Tomorrow, Jul 20',
  },
  {
    id: 'gaming-laptop', dept: 'electronics',
    title: 'Gaming Laptop 16", RTX 4070, 32GB RAM, 1TB SSD, 240Hz QHD Display',
    price: 1499, listPrice: 1799, rating: 4.6, reviews: 6210, bought: '900+ bought in past month',
    coupon: 5, prime: true, delivery: 'Tomorrow, Jul 20',
  },
  {
    id: 'router', dept: 'electronics',
    title: 'Tri-Band WiFi 6E Mesh Router System (3-Pack), Covers 6,000 sq ft',
    price: 299, listPrice: 399, rating: 4.5, reviews: 12030, coupon: 10, prime: true, delivery: 'Tomorrow, Jul 20',
  },

  /* ── Computers & Components ── */
  {
    id: 'psu', dept: 'components',
    title: '850W 80+ Gold Fully Modular ATX Power Supply, 10-Year Warranty',
    price: 129, listPrice: 159, rating: 4.8, reviews: 28940, bought: '3K+ bought in past month',
    badge: { kind: 'choice', text: "Amazon's Choice" }, prime: true, delivery: 'Tomorrow, Jul 20',
  },
  {
    id: 'cpu-cooler', dept: 'components',
    title: 'Dual-Tower CPU Air Cooler, 7 Heat Pipes, ARGB 120mm Fans',
    price: 59, listPrice: 79, rating: 4.7, reviews: 19210, coupon: 10, prime: true, delivery: 'Tomorrow, Jul 20',
  },
  {
    id: 'motherboard', dept: 'components',
    title: 'X670E Gaming Motherboard, Socket AM5, DDR5, PCIe 5.0, WiFi 6E',
    price: 289, listPrice: 349, rating: 4.7, reviews: 9140, bought: '1K+ bought in past month',
    badge: { kind: 'best', text: '#1 Best Seller' }, prime: true, delivery: 'Tomorrow, Jul 20',
  },
  {
    id: 'pc-case', dept: 'components',
    title: 'Mid-Tower ATX PC Case, Tempered Glass, 4 Pre-Installed ARGB Fans',
    price: 89, listPrice: 119, rating: 4.6, reviews: 24310, bought: '2K+ bought in past month',
    coupon: 10, prime: true, delivery: 'Tomorrow, Jul 20',
  },
  {
  ...
  {
    id: 'matcha',
    title: 'Ceremonial Grade Organic Matcha Green Tea Powder, 100g',
    price: 24.99, listPrice: 29.99, unit: '($7.08 / oz)', rating: 4.8, reviews: 34210, bought: '5K+ bought in past month',
    badge: { kind: 'choice', text: "Amazon's Choice" }, coupon: 10, prime: true, delivery: 'Tomorrow, Jul 20',
  },
  {
    id: 'kimchi',
    title: 'Traditional Napa Cabbage Kimchi, Vegan, 28 oz Jar',
    price: 13.99, unit: '($0.50 / oz)', rating: 4.6, reviews: 8940, prime: true, delivery: 'Tomorrow, Jul 20',
  },
  {
    id: 'mochi',
    title: 'Assorted Japanese Daifuku Mochi Rice Cakes, 15 Count Variety Box',
    price: 16.99, unit: '($1.13 / Count)', rating: 4.7, reviews: 12310, badge: { kind: 'overall', text: 'Overall Pick' }, prime: true, delivery: 'Tomorrow, Jul 20',
  },
  {
    id: 'rice-crackers',
    title: 'Japanese Rice Cracker Senbei Snack Mix, Party Size 2 lb',
    price: 18.49, unit: '($0.58 / oz)', rating: 4.6, reviews: 6720, prime: true, delivery: 'Tomorrow, Jul 20',
  },
  {
    id: 'curry-roux',
    title: 'Japanese Curry Roux Sauce Blocks, Medium Hot, Pack of 6',
    price: 21.99, unit: '($3.67 / Count)', rating: 4.8, reviews: 15980, bought: '2K+ bought in past month',
    badge: { kind: 'best', text: '#1 Best Seller' }, prime: true, delivery: 'Tomorrow, Jul 20',
  },
  {
    id: 'boba',
    title: 'DIY Bubble Tea Kit — Tapioca Pearls, Brown Sugar & Straws, 10 Servings',
    price: 19.99, listPrice: 24.99, unit: '($2.00 / serving)', rating: 4.7, reviews: 22140, bought: '3K+ bought in past month',
    coupon: 15, prime: true, delivery: 'Tomorrow, Jul 20',
  },
];
